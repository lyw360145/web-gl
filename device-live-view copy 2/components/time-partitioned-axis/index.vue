...
function updateAnchorVideoList() {
  ...
  anchorVideoList.value = videoList.filter((video: any) => (video.start <= currentTime.value && video.end >= currentTime.value))
  if (anchorVideoList.value.length) {
    console.log('👊 ~ anchorVideoList.value', anchorVideoList.value)
